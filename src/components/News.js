...
const News = (props) => {
    ...
    useEffect(() =>{
        document.title = `${capitalizeFirstLetter(props.category)} - NewsHorse`
    ...
    const fetchMoreData = async() =>{
        ...
        return (
        <>
            <h1 className='text-center' style={{margin: '35px 0px', marginTop: '90px'}}>NewsHorse - Top {capitalizeFirstLetter(props.category)} Headlines</h1>
            {loading && <Spinner/>}
